...
function Hero21() {
    return (
        <div className="mmm">
            <div className="abou">
                <h2>ABOUT <span className="ass">G</span><span>YM</span> <span className="edg">EDGE</span></h2>
                <p>Gym Edge is a modern fitness center focused on helping people achieve their health goals.
            ...
            <div className="unplu">
                <img src="https://media.istockphoto.com/id/2218966877/photo/young-male-athlete-adding-weights-to-barbell-in-gym.webp?a=1&b=1&s=612x612&w=0&k=20&c=A_kY9YwsMtwUZ1rTBsysheY23NrmfCwY65FbkIo0FXY=" alt="" />
            </div>
